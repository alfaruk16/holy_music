package com.holymusic.app.features.presentation.my_plans.components
...
fun RobiCancelDialogue(
    ...
    Dialog(onDismissRequest = { onDismiss() }) {
        ...
        Column(
            ...
            Text(
                text = "সার্ভিস টি ক্যানসেল করতে এই নম্বর $mobile থেকে stop $code লিখে 21213 তে সেন্ড করুন",
                color = Primary,
