...
@Composable
fun BanglalinkPaymentDialogue(
    isBanglalink: Boolean,
    user: String,
    mobile: String,
    ...
    Dialog(onDismissRequest = { onDismiss() }) {
        ...
        Column(
            ...
            Text(
                text = stringResource(id = R.string.banglalink_number),
            ...
            if (isBanglalink)
                ...
                TextFieldK(
                    ...
                    error = if (isValidate && !Common.isBanglalink(mobile)) stringResource(
                        id = R.string.enter_valid_bl_mobile
            ...
            Row(
                ...
                Box(
                    ...
                    modifier = Modifier
                        ...
                        .clickable {
                            proceed(if (isBanglalink) user else "88$mobile")
                        }
                ) {
                    Text(
